...
const RetrieveProfileComponent = (props) => {
    const {
      openmodal,
    full_name, user, bio, timestamp, followers, following} = props
  ...
  return (
    <div class="col">
      ...
      <div><button onClick={openmodal} type="button">Edit Profile</button></div>
        </div>
      </div>
  )
}
