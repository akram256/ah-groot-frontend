...
describe('Test all reducers', () => {
  ...
  test('reducers', () => {
    ...
    state = reducers(
      {
        ...
        userArticles: [
          {
            ...
            average_rating: 4,
            user_rates: '0',
            created_at: '2019-04-23T10:54:04.663217+03:00',
            updated_at: '2019-04-23T10:54:07.135585+03:00',
            favorited: false,
            favorites_count: 0,
            is_published: true,
            author: {
              ...
              bio: 'this is it',
              image:
                'https://firebasestorage.googleapis.com/v0/b/authors-heaven-groot.appspot.com/o/images%2FPhoto%20on%2016-02-2019%20at%2011.09.jpg?alt=media&token=5efd509f-80ee-448f-93af-a937981bf644',
              follower_count: 0,
              following_count: 0,
        ...
        dislikeReducer: { likes: 0, dislikes: 0 },
        retrieveProfile: { profile: {}, loading: false },
      },
      {
    ...
    expect(state).toEqual({
      ...
      dislikeReducer: { likes: 0, dislikes: 0 },
      retrieveProfile: { profile: {}, loading: false },
      ratingReducer: { error: null, loading: false, successMsg: null },
      reportingReducer: {
             error: null,
             loading: false,
             successMsg: null,
